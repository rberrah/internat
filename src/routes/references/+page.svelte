...
<header class="head">
  ...
  <h1>Références</h1>
  <p class="lede">
    Les <strong>{total} sources</strong> sur lesquelles s'appuie ce site : référentiels officiels
    (programme du concours, ANSM, HAS), collèges d'enseignants (E.PILLY, REMIC, ANOFEL), sociétés
    savantes et recommandations. Chaque chapitre <strong>cite les siennes</strong> en pied de page —
    <strong>{sourced}/{chapters.length}</strong> chapitres sont sourcés.
  </p>
  <p class="note">
