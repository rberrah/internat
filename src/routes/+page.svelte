...
<section class="hero">
  <p class="eyebrow">Concours de l'internat en pharmacie</p>
  <h1>Réviser l'internat, <span>en visuel et interactif</span>.</h1>
  <p class="lede">
    Des fiches courtes, des schémas manipulables et des exercices corrigés, discipline par
    discipline. On raconte le mécanisme avant de retenir la formule — pour comprendre, pas
    seulement mémoriser.
  </p>
  <div class="cta">
    <a class="btn btn-primary" href={`${base}/chapitres`}>Explorer les disciplines</a>
    <a class="btn btn-outline" href={`${base}/exercices`}>S'entraîner</a>
  </div>
  <p class="stat">{total} chapitre{total > 1 ? 's' : ''} · programme officiel (5 sections)</p>
</section>
